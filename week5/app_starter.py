"""
Week 5: Agent Architecture (TechCorp LLM Agent)

An AI agent that answers TechCorp business questions by combining:
...
Access control note: `user_role` is accepted and passed into the system prompt
as context, but is NOT enforced this week. Week 6 adds enforcement.
"""
